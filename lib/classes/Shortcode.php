...
class Shortcode{
	public static function init() {
		add_shortcode('video', [ __CLASS__, 'custom_policy_stream_name' ] );
	}
	...
	public static function custom_policy_stream_name($atts){
